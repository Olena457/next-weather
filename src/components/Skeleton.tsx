  ...
  return (
    <div className="flex flex-col gap-9 w-full pb-10 pt-4 animate-pulse">
      <section className="space-y-4">
        ...
        <div className="w-full bg-gray-200 border border-gray-300 rounded-[40px] shadow-md h-[350px] sm:h-[450px]">
      ...
      <section className="flex w-full flex-col gap-4">
        ...
        {[1, 2].map((index) => (
          <div
            key={index}
            className="w-full h-16 bg-gray-200 border border-gray-300 rounded-[40px] shadow-sm"
          ></div>
        ))}
      </section>
    </div>
